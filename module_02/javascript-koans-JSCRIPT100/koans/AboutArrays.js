describe("About Arrays", function() {
  ...
  // Goal: Understand more about creating, using, and manipulating Arrays
  // Read Chapter 4 Arrays in Head First JavaScript programming
  // also read: https://www.w3schools.com/jsref/jsref_obj_array.asp and
